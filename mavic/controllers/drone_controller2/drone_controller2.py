...
display = robot.getDevice("display3")
emitter = robot.getDevice("emitter3")
receiver = robot.getDevice("receiver3")
...
# === WAYPOINT AYARI ===
# ============================================
X_START = 15.0   # X başlangıç (batı)
X_END = 30.0     # X bitiş (doğu)
Y_START = 0.0    # Y başlangıç (kuzey)
Y_END = 8     # Y bitiş (güney)
